  ...
  const cards = [
    {
      ...
      text: 'Our language centre Offerss group or personal lessons, various modern languages for all ages and levels of knowledge.',
            ...
            <div className="relative h-full">
              ...
              {hoveredIndex === index && (
                <div className="absolute top-0 left-0 w-full h-full flex flex-col items-center justify-center bg-black bg-opacity-50">
                  <p className="text-white text-2xl">{card.heading}</p>
